...
progress: undefined,
  ...
  return (
    <nav
      className='nav-position relative z-10 top-0 flex justify-between items-center h-16 topbarr text-white shadow-sm'
      role='navigation'
    >
      <NavLink to='/' className='flex pl-8 items-center'>
        <img style={{filter:"drop-shadow(0px 0px 15px rgba(255, 0, 0, 1))"} } width="50" height="50" src="/assets/logo.svg" className="cc-logo" alt="logo" />
        <p className="mt-2 ml-3 headline" style={{ filter: "drop-shadow(5px 5px 10px rgba(255, 0, 0, 1))", lineHeight:"60%"} }>CODING &nbsp; CLUB</p>
      </NavLink>
