...
function Login() {
    return(
        <div>
        <Fade>
        <div className="w-full flex items-center justify-center login mt-8 mb-10 p-4">
        <form className="w-full md:w-1/3 bg-white rounded-lg login-form">
            ...
            <div className="px-12 pb-10 ">
                <div className="w-full mb-2">
                    <div className="flex items-center">
                        ...
                        <input type='text' placeholder="Username"
                             className="-mx-6 px-8 bg-transparent w-full border-b-2 border-red-500 border-teal-600 bg-teal-400 p-8 rounded px-3 py-2 border-black text-black focus:outline-none" />
                    </div>
                </div>
                <div className="w-full mb-2">
                    <div className="flex items-center">
                ...
                <button type="submit"
                            ...
                            <button type="submit"
                                className="login-button mt-4 w-full py-2 rounded-full bg-red-500 text-gray-100  focus:outline-none">Login with BITS Mail
                            </button>
            </div>
        </form>
    </div>
